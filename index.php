        ...
        <div class="col-sm-4 det-right">
          <div class="sec1">
            <h2><i class="fa fa-envelope" aria-hidden="true"></i> Email</h2>
  					&nbsp<a href="mailto:lucifer@fsociety.co.in">lucifer@fsociety.co.in</a><br/>
  					&nbsp<a href="mailto:raggedyman@fsociety.co.in">raggedyman@fsociety.co.in</a>
          </div>
          <div class="sec2">
						<h2><i class="fa fa-phone" aria-hidden="true"></i> Phone</h2>
						&nbsp<span>01100010 &nbsp 01101111 &nbsp 01110100</span>
          </div>
          <div class="sec3">
						<h2><i class="fa fa-map-marker" aria-hidden="true"></i> Address</h2>
						&nbsp<span>104.31.64.158</span>
          </div>
        </div>
      </div>
